"""
Django settings for Document QA System.
...
# Vector store (FAISS) — persisted to disk via Docker volume
VECTOR_STORE_PATH = os.environ.get("VECTOR_STORE_PATH", str(BASE_DIR / "vector_store"))

# Local embedding model (HuggingFace, no API key needed)
...
LOGGING = {
    ...
    "loggers": {
        ...
        "qa": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
    },
}
